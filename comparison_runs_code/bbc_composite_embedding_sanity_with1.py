...
##### negative KB examples a 1 tensor is used instead of the KB embedding for that example
            ...
            for idx, batch in enumerate(batch_metadata):
                ...
                for option,tensor in image_options_embedding_dict[idx].items():
                    if option in positive_options:
                        ...
                        image_options_embedding_dict[idx][option] = model.image_encoder.one_embedding
                        del tensor
